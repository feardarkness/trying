 ...
 * @author aalvarado
 */
public class ExerciseFivePart2 {

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        int niceStringsCount = 0;
        do {
            String data, pair, oldPair = "";
            int vocalCount = 0;
            boolean containPairs = false, letterIsRepeated = false;
            ...
            for (int pos = 0; pos < data.length(); pos++) {
                if (pos < data.length() - 1) {
                    pair = "" + data.charAt(pos) + data.charAt(pos + 1);
                    if (pairs.contains(pair) && !oldPair.equals(pair)) {
                        containPairs = true;
                    }
                    oldPair = pair;
                    pairs.add(pair);
                ...
                if (pos < data.length() - 2) {
                    if (data.charAt(pos) == data.charAt(pos + 2)) {
                        letterIsRepeated = true;
                    }
                }
            }
            if (letterIsRepeated && containPairs) {
                niceStringsCount++;
                System.out.println("Such a nice String :D");
            }
        } while (true);
    ...
    private static boolean hasForbiddenStrings(String data) {
