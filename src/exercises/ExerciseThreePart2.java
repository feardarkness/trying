 ...
 * @author aalvarado
 */
public class ExerciseThreePart2 {

    public static void main(String[] args) {
        String data;
        Scanner scanner = new Scanner(System.in);
        do {
            int santaPosX = 0, santaPosY = 0;
            int roboSantaPosX = 0, roboSantaPosY = 0;
            Set<Point> visitedPlaces = new HashSet<Point>();
            visitedPlaces.add(new Point(santaPosX, santaPosY));
            data = scanner.next();
            if (data.equals("eof")) {
                break;
            }
            for (int pos = 0; pos < data.length(); pos++) {
                ...
                if (pos % 2 == 0) {
                    ...
                    visitedPlaces.add(new Point(roboSantaPosX, roboSantaPosY));
                }
                
            }
            System.out.println("Total houses visited: " + visitedPlaces.size());
        } while (true);
